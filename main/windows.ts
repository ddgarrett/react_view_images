...
/** App root directory (where main.js, preload.js live). */
let appRoot: string;
...
/** Path to the main window HTML: dist/index.html (React build) or index.html (dev). */
function getMainWindowHtmlPath(): string {
...
export function createMainWindow(): void {
  ...
  void win.loadFile(getMainWindowHtmlPath());
}
